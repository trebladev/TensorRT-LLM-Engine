...
public:
    ...
    //! Refresh external candidates and per-request decoder depth before each generation iteration.
    void refreshExternalDraftTokens(RequestVector const& requests, runtime::decoder::DecoderState& decoderState,
        runtime::ModelConfig const& modelConfig, runtime::WorldConfig const& worldConfig,
        runtime::CudaStream const& decoderStream) const;
